            ...
            <div className="modal-editar" onClick={(e) => e.stopPropagation()}>
              ...
              {semEstoque.length > 0 ? (
                <>
                  <div className="flex flex-col justify-start items-start gap-3">
                    <div className="flex flex-col justify-start items-start w-full gap-1">
                      ...
                      <select
                        name="antigo"
                        className="!p-2 !border-1 !border-gray-300 !rounded-2xl !w-full !bg-white"
                        value={novoEstoque || ''}
                        onChange={(e) => {
                    ...
                    <div className="flex flex-col justify-start items-start w-full">
                      ...
                      <input
                        ...
                        className="!p-2 !px-4 !border-1 !border-gray-300 !rounded-2xl !w-full !bg-white"
                      />
                    </div>
                  </div>
                ...
                <div className="flex flex-col items-center justify-center gap-6">
                  <h1 className="text-gray-600 text-lg mt-4">
                    Você já tem todos os produtos cadastrados. <br />
                    Apenas altere os valores na tabela.
                  </h1>
                  <button
                    className="btn-confirmar w-[50%]"
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <div className="relative flex items-center w-full md:w-32">
            ...
            <input
              type="text"
              placeholder="ID"
              className="!px-7 py-3 border rounded-lg w-full focus:outline-none focus:border-green-500"
              value={filtroId}
          ...
          <div className="relative flex items-center w-full md:w-64">
            ...
            <input
              ...
              className="!px-10 py-3 border rounded-lg w-full focus:outline-none focus:border-green-500"
              value={filtroNome}
